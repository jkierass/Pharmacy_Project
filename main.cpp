...
int main()
{
	...
	std::vector<std::string> tmp_symptoms = { "muscle_pain", "back_pain", "arthritis", "cuts", "disinfection", "eye_redness", "dry_eye", "diarrhea"};
	Client new_client;
	new_client.symptoms = tmp_symptoms;
	new_pharmacist.choose_medicines(new_client, pharmacist_knowledge);
	new_pharmacist.print_receipt(new_client);
